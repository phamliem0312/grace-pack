...
```
node build --copy; site/vendor/bin/phpunit site/tests/unit/Espo/Modules/GracePack
```
...
```
(cd site && vendor/bin/phpunit tests/integration/Espo/Modules/GracePack)
```
...
* `site/custom/`
* `site/client/custom/`
* `site/tests/unit/Espo/Modules/GracePack`
* `site/tests/integration/Espo/Modules/GracePack`
...
2. Set *bundled* and *jsTranspiled* to true in `src/files/custom/Espo/Modules/GracePack/Resources/module.json`.
3. Add `src/files/custom/Espo/Modules/GracePack/Resources/metadata/app/client.json`
    ```json
    {
        "scriptList": [
            "__APPEND__",
            "client/custom/modules/grace-pack/lib/init.js"
        ]
    }
    ```
